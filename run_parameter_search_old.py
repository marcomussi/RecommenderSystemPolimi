...
def runParameterSearch_Collaborative(recommender_class, URM_train, ICM_1, ICM_2, metric_to_optimize="PRECISION",
    ...
    try:
        ...
        if recommender_class is HybridRecommender:
            ...
            hyperparamethers_range_dictionary = {}
            hyperparamethers_range_dictionary["w_itemcf"] = [x * 0.1+1 for x in range(0, 10)]
            hyperparamethers_range_dictionary["w_usercf"] = [x * 0.1 for x in range(0, 10)]
            hyperparamethers_range_dictionary["w_cbart"] = [x * 0.1 for x in range(0, 10)]
            hyperparamethers_range_dictionary["w_cbalb"] = [x * 0.1 for x in range(0, 10)]
            hyperparamethers_range_dictionary["w_slim"] = [x * 0.1 for x in range(0, 10)]
        ...
        if recommender_class is MultiThreadSLIM_ElasticNet:
            hyperparamethers_range_dictionary = {}
            hyperparamethers_range_dictionary["topK"] = [10, 100, 200, 500, 600, 1000, 2000]
            hyperparamethers_range_dictionary["l1_penalty"] = [1e-5,1e-6, 1e-4, 1e-3]
            hyperparamethers_range_dictionary["l2_penalty"] = [1e-5,1e-6, 1e-4, 1e-3]
